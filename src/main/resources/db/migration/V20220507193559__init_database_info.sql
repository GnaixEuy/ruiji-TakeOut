...
CREATE TABLE `address_book` (
                                ...
                                `consignee` varchar(50) COLLATE utf8mb4_bin NOT NULL COMMENT '收货人',
...
CREATE TABLE `category` (
                            ...
                            `name` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '分类名称',
...
CREATE TABLE `dish` (
                        `id` bigint(20) NOT NULL COMMENT '主键',
                        `name` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '菜品名称',
                        `category_id` bigint(20) NOT NULL COMMENT '菜品分类id',
                        `price` decimal(10,2) DEFAULT NULL COMMENT '菜品价格',
                        `code` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '商品码',
                        `image` varchar(200) COLLATE utf8mb4_bin NOT NULL COMMENT '图片',
                        `description` varchar(400) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '描述信息',
...
CREATE TABLE `dish_flavor` (
                               ...
                               `name` varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '口味名称',
                               `value` varchar(500) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '口味数据list',
                               `create_time` datetime NOT NULL COMMENT '创建时间',
                               `update_time` datetime NOT NULL COMMENT '更新时间',
                               `create_user` bigint(20) NOT NULL COMMENT '创建人',
                               `update_user` bigint(20) NOT NULL COMMENT '修改人',
...
CREATE TABLE `orders` (
                          ...
                          `consignee` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
                          PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `order_detail`(
                               `id`          bigint(20) NOT NULL COMMENT '主键',
                               `name`        varchar(50) COLLATE utf8mb4_bin  DEFAULT NULL COMMENT '名字',
                               `image`       varchar(100) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '图片',
...
(
    `id`          bigint(20) NOT NULL COMMENT '主键',
    `category_id` bigint(20) NOT NULL COMMENT '菜品分类id',
    `name`        varchar(64) COLLATE utf8mb4_bin NOT NULL COMMENT '套餐名称',
    `price`       decimal(10, 2)                  NOT NULL COMMENT '套餐价格',
    `status`      int(11) DEFAULT NULL COMMENT '状态 0:停用 1:启用',
    `code`        varchar(32) COLLATE utf8mb4_bin  DEFAULT NULL COMMENT '编码',
    `description` varchar(512) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '描述信息',
...
(
    `id`          bigint(20) NOT NULL COMMENT '主键',
    `set_meal_id` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '套餐id ',
    `dish_id`     varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '菜品id',
...
CREATE TABLE `user` (
                        ...
                        `phone` varchar(100) COLLATE utf8mb4_bin NOT NULL COMMENT '手机号',
